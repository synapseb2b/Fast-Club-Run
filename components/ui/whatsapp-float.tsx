...
export function WhatsAppFloat() {
    return (
        <motion.a
            ...
            className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 bg-primary rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300"
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 1.5, type: "spring", stiffness: 200 }}
        >
            {/* SVG oficial do WhatsApp - cor branca */}
